                ...
                <div className="flex-1 max-w-2xl">
                    ...
                    >
                        <div className="inline-block relative">
                            <div  />
                            <span className="relative text-xl md:text-2xl font-medium px-4 py-2 bg-white dark:bg-gray-800 rounded-lg">
                                Hello Guys 👋
                            </span>
                        </div>
                    </motion.div>
                    ...
                    >
                        {skills.map((skill, index) => (
                            <motion.span
                                key={skill}
                                className="px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-indigo-600/10 to-purple-600/10 border border-indigo-600/20 text-indigo-700 dark:text-indigo-300"
                    ...
                    >
                        {[
                            ...
                            { name: 'Email', icon: 'gmail.svg' },
                            { name: 'LinkedIn', icon: 'linkedin.svg' },
                            { name: 'Stack Overflow', icon: 'stackoverflow.svg' },
                        ].map((social, i) => (
                            <motion.a
                                key={social.name}
                                href="#"
                            ...
                            <div className="flex-1 max-w-md">
                                ...
                                >
                                    <img
                                        ...
                                        className="w-80 h-80 rounded-full object-cover object-top border-4 border-white shadow-xl mb-6"
                                    />
